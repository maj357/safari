...
// Benefits slider
if (document.querySelector('.premium__benefits-body')) {
	let benefitsSlider = new Swiper('.premium__benefits-body', {
		observer: true,
		observeParents: true,
		slidesPerView: 3,
		spaceBetween: 0,
...
window.onload = function () {
	...
	$('.icon-menu').on('click', function () {
		...
		$('.header__title').toggleClass('_active');
	});
